...
typedef void(^BLLetAsyncRequestCallback)(NSString *_Nullable);
typedef void(^DeviceConfigCallback)(NSString *_Nullable);
typedef void(^SubDeviceManagementCallback)(NSString *_Nullable);
typedef void(^DeviceInfoCallback)(NSString *_Nullable);
/**
